...
class Item_transaksi extends Model 
{
    ...
    */
    ...
    {
        $query = 'select id_transaksi, harga_jual, id_barang, sum(qty) as qty,diskon from item_transaksi_penjualan where id_transaksi="'.$id_transaksi.'" group by id_barang, diskon';
