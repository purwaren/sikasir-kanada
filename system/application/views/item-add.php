    ...
    <div class="left_articles">        
        ...
        <table cellspacing="0" cellpadding="0" class="table-data" style="width: 850px; margin: 0px;">
            ...
            echo '<tr class="row-data">
                ...
                <td style="width: 80px;"><input type="text" name="id_barang[]" maxlength="'.config_item('item_length').'" class="item_code" onkeyup="setFocus('.$i.')" style="width:105px;"/><span id="id_barang_'.$i.'" style="display:none"></span></td>
